...
n_queue_name = 'Notifications' # queue to be subscribed by Activity_Log microservice
...
def receiveNotifications(channel):
    try:
        ...
        print('Notifications: Consuming from queue:', n_queue_name)
...
def callback(channel, method, properties, body): # required signature for the callback; no return
    print("\nNotifications: Received an order log by " + __file__)
